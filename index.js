...
function getLoan(){
    ...
    document.getElementById("balance-loan-placeholder").innerHTML =    "Loan Balance";
    paidLoan = false
    showHide()
...
const selectLaptop = e => {
    const selectedLaptop = laptops[e.target.selectedIndex];
     ...
     laptopImg.innerText = selectedLaptop.image
...
const selectedLaptop = laptops[selectElement.selectedIndex]
c
